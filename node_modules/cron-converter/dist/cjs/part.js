...
exports.stringToArrayPart = exports.arrayToStringPart = void 0;
 ...
 */
const arrayToStringPart = (arr, unit, options) => {
...
exports.arrayToStringPart = arrayToStringPart;
/**
...
const stringToArrayPart = (str, unit) => {
    const values = (0, util_js_1.sort)((0, util_js_1.dedup)(fixSunday((0, util_js_1.flatten)(replaceAlternatives(str, unit)
        ...
        if (left === "*") {
            parsedValues = (0, util_js_1.range)(unit.min, unit.max);
        }
        else {
...
exports.stringToArrayPart = stringToArrayPart;
/**
...
const parseRange = (rangeString, context, unit) => {
    ...
    if (subparts.length === 1) {
        ...
        return (0, util_js_1.range)(minValue, maxValue);
    }
    else {
