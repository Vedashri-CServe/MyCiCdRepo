...
const routes = [
    ...
    {
        path: 'todo',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_ng-select_ng-select___ivy_ngcc___fesm2015_ng-select-ng-select_js"), __webpack_require__.e("default-node_modules_ng2-flatpickr___ivy_ngcc___fesm2015_ng2-flatpickr_js"), __webpack_require__.e("default-node_modules_ngx-quill___ivy_ngcc___fesm2015_ngx-quill_js"), __webpack_require__.e("src_app_main_apps_todo_todo_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./todo/todo.module */ 43261)).then(m => m.TodoModule)
    },
    {
        path: 'calendar',
    ...
    {
        path: 'e-commerce',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_main_apps_ecommerce_ecommerce_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./ecommerce/ecommerce.module */ 46130)).then(m => m.EcommerceModule)
    },
    {
        path: 'user',
...
class FullCalendarComponent {
  ...
  ngAfterViewInit() {
    ...
    const options = this.options || {}; // initialize snapshot
  ...
  */
  ...
  ngDoCheck() {
    if (this.calendar) {
      ...
      let anyChanges = false; // detect adds and updates (and update snapshot)
      ...
      const oldOptionNames = Object.keys(optionSnapshot); // detect removals (and update snapshot)
